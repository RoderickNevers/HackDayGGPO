...
public class SteamManager : MonoBehaviour
{
    ...
    private bool IsFacepunchHost = false;
    ...
    protected virtual void Awake()
    {
        ...
        try
        {
            ...
            if (Steamworks.SteamClient.RestartAppIfNecessary(0))
            {
                Application.Quit();
                return;
            }
        ...
        try
        {
            SteamClient.Init(SteamClient.AppId.Value);
    ...
    protected virtual void Update()
    {
        ...
        try
        {
            if (IsFacepunchHost && socketManager != null)
            {
        ...
        {
            Debug.Log("Error receiving data on connection");
        }
    }

    // Designate one user to be the host, to wait on an incoming connection
    ...
    public void CloseSteamworksConnection()
    {
        // Close connection
        try
        {
